...
mod tests {
    ...
    fn wallet_to_base58() {
        ...
        let wallet = stdin
            ...
            .collect::<Vec<u8>>();
        let keypair = wallet.clone();
        println!("Your Base58-encoded private key is:");
        let base58 = bs58::encode(wallet).into_string();
        println!("{:?}", base58);

        let keypair = Keypair::from_bytes(&keypair).expect("Invalid keypair");
    ...
    #[test]
    fn claim_airdrop() {
        // public url we are sending it to : 7NK1Nrom8doHXdspnbWeYd6mgTXRGUdegUhXiJpW4FqT
        // const RPC_URL: &str = "https://solana-devnet.g.alchemy.com/v2/R2eNS6GVvgDRP_RgYS9JeIJaoXaXeCgJ";
        ...
        // println!("Checking pub key {:?}", keypair.pubkey());
        match client.request_airdrop(&keypair.pubkey(), 2_000_000_000u64) {
            Ok(sig) => {
                println!("Success! Check your TX here:");
                println!("Transaction Signature: {}", sig);
                println!("https://explorer.solana.com/tx/{}?cluster=devnet", sig);
                // Confirm transaction with correct commitment
            }
            Err(err) => {
    ...
    fn airdrop() {
        ...
        let accounts = vec![
            ...
            // AccountMeta::new_readonly(prereq_pda, false), // authority (PDA)
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("GGsw1CyeMFkH7eo2ta8p2DgzzWApzFLkX1D4Q3HXsFHR").unwrap();
